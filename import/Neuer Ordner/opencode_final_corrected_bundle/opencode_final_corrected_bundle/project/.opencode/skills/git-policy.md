---
name: git-policy
description: Lade diesen Skill IMMER, wenn du einen git commit, git push, git reset oder andere Versionskontroll-Aktionen durchführst.
---
...
## 2. 🛑 NON-NEGOTIABLE
1. **Double-Turn-Lock:** Verify nobody else is pushing to this branch. Niemals `write` und `git commit` im selben Turn kombinieren.

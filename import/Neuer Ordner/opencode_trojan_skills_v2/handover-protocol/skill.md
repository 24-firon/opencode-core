...
description: |
  Lade diesen Skill, wenn du eine Session startest, beendest oder Handover-Dateien wie BRAIN_UPLOAD.md oder task.md bearbeitest.
  ...
  - `walkthrough.md / BRAIN_UPLOAD.md` (Vergangenheit & Realität):
    ...
    - Wenn der Plan bei der Ausführung nicht funktioniert hat und der Code anders geschrieben werden musste, wird dieses Delta und die reale Lösung hier protokolliert, nicht rückwirkend im Plan.
